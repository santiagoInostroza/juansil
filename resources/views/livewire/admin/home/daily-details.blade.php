    ...
    <div class="flex justify-between items-center gap-2 ">
      <div class="flex gap-4 items-center w-full">
        ...
        <div class="flex gap-16 w-96 items-center ">
          <div class="border text-black font-bold py-1" style="text-shadow: 1px 1px white; width: {{$sales[$date->format('Y-m-d')]['sales_percentage']}}%; background: rgb({{  255 - ($sales[$date->format('Y-m-d')]['sales_percentage'] * 2.55)}}, 100, 0)">
