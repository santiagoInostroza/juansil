<div class="card mt-5 bg-gray-200" x-data="{open:false}">
    ...
    @else
        <div class="card-header">
            <h2 class="" x-on:click="open=!open" style="cursor: pointer">Pendientes ({{ $entregas_pendientes }} ) 
                {{-- Total pendiente ${{ number_format($ventas->sum('total'),0,',','.')}} --}}
            </h2>
        </div>
                ...
                @foreach ($ventas as $venta)
                    <div class="shadow p-4 bg-white rounded">
                        <div class="py-4 pb-8">
                            ...
                            @if ($venta->customer->comments)
                                <div class="text-red-700 text-left bg-red-200 p-2">
