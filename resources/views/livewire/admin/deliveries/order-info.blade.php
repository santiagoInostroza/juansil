            ...
            <article class="bg-white shadow rounded p-4">
                ...
                <div class=" flex flex-wrap items-center gap-2 " >
                    ...
                    <div id="info_{{$venta->id}}" x-data="{open:false}" class="text-base">
                        ...
                        {{-- BOTON SUBIR IMAGEN --}}
                    <div id="payment_receipt_{{$venta->id}}" x-data="{isOpenAddPaymentReceipt:false}">
                        ...
                        @if ($venta->payment_receipt_url == null)
                        ...
                        @else
                            <x-jet-secondary-button x-on:click="isOpenAddPaymentReceipt = true">
                                <i class="fas fa-camera text-lg"></i>1
                            </x-jet-secondary-button>
                        @endif
                        ...
                        <div x-cloack x-show="isOpenAddPaymentReceipt" x.on:click.away="isOpenAddPaymentReceipt=false">
                            <x-modal.alert2>
                                <div>
                                    <x-slot name="header">Recibo de pago</x-slot>
                                    <x-slot name="body">  
                                        <img class="max-w-sm max-h-72 object-cover m-auto" src="{{Storage::url($venta->payment_receipt_url) }}" alt="Imagen del recibo">
                                    </x-slot>
                                    <x-slot name="footer">
