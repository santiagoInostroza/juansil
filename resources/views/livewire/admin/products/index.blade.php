<div id="productsMain" x-data="productsMain()" x-init="start()">
    ...
    <div class="mb-20">
        ...
        <div class="my-4 p-4 border rounded ">
            <div class="relative">
                <x-jet-input class="w-full" wire:model.debounce.700ms="search" placeholder="Buscar..."></x-jet-input>
                                ...
                                <tr wire:click="editRowTrue({{ $product->id }})">
                                    ...
                                    <td class="px-6 py-4  whitespace-nowrap ">
                                        <div class="flex justify-between items-center gap-4 w-max-content relative" >
                                            ...
                                            <div class="grid w-full">
                                                <div class="text-sm text-gray-500   flex justify-between items-center relative w-full p-1 px-2 rounded">
                                                    <div class="w-max-content font-bold"> {{$product->name}}</div>
                                                </div>
                                                {{-- MARCA --}}
                                                <div class="text-sm text-gray-500  flex justify-between items-center relative  p-1 px-2 rounded  w-full"  >
                                                    <div class="flex justify-start gap-x-1">
                                                        <div>Marca: </div>
                                    ...
                                    <td class=" whitespace-nowrap text-sm text-gray-500">
                                        <div class="w-full h-full px-6 py-4">
                                            <div class="flex flex-col items-center justify-start p-4">
                                                @foreach ($product->tags as $tag)
                                                    <div  class="p-1">
                                                        <div  class="px-1 border rounded-full bg-{{$tag->color}}-200 ">{{$tag->name}}</div>
                                                    </div>
                                                @endforeach
                                            </div>                                            
                                        </div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        <div class="flex flex-col items-center justify-center">
                                            <div  class="relative p-2  font-bold w-20 hover:bg-gray-100 rounded hover:border">
                                                ${{ number_format($product->special_sale_price,0,',','.')}}
                                            </div> 
                                            <div class="w-max-content">
                                                {{ $product->formato }} x  ${{ number_format($product->special_sale_price * $product->formato ,0,',','.') }}
