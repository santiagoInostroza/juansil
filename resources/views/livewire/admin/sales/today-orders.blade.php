<div  x-data="{openEdit:false,loadingEdit:false}" class="text-gray-800">
            ...
            @foreach ($sales as $sale)
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                    ...
                    <td>
                        <div>
                            <div class="text-right">
                                <x-jet-button x-on:click="openEdit=true;$wire.selectedOrderEdit({{ $sale->id}})" class="bg-yellow-200 hover:bg-yellow-400"><i class="fas fa-pen"></i></x-jet-button>
    ...
    <div x-show="openEdit" class="hidden" :class="{'hidden': !openEdit}">
        <x-modal.modal2>
            <div class="p-2">
                <div class="flex justify-between gap-4 items-center">
                    <h2 class="text-xl font-bold text-gray-600">Editar {{$orderEdit->id}}</h2>
                    <div x-on:click="openEdit=false" class="p-2 cursor-pointer">
                ...
                <div>
                    ...
                    <div x-data class="my-4">
                        <x-jet-button class="w-full" x-on:click="$wire.modificateOrder()">Modificar Pedido</x-jet-button>
                    </div>
                </div>
            </div>
        </x-modal.modal2>
