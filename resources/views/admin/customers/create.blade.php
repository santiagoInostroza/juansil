...
@section('content')
    <div class="card container">
        <div class="card-body">
            {!! Form::open(['route' => 'admin.customers.store', 'autocomplete' => 'off', 'files' => 'true', 'id' => 'form']) !!}
            @include('admin.customers.partials.form')
            {{-- {!! Form::submit('Crear Cliente', ['class' => 'btn btn-primary btn-block']) !!} --}}

        
                <div class="btn btn-primary btn-block" onclick="$('#form').submit()">Crear Cliente</div>
                    ...
                    if (place.address_components) {
                        address = [
                            (place.address_components[1] && place
                                ...
                                .short_name || ' '), (place.address_components[
                                    0] && place
                                .address_components[0].short_name || ''),
                            (place.address_components[2] && place
                                .address_components[2]
                                .short_name || ''),
                            (place.address_components[3] && place
                                .address_components[3]
                                .short_name || ''),
                            (place.address_components[4] && place
                                .address_components[4]
                                .short_name || ''),
                            (place.address_components[5] && place
                                .address_components[5]
                                .short_name || ''),
                            // (place.address_components[6] && place.address_components[6].short_name || '')
                        ];
                        let comuna = document.getElementById('comuna');
                        comuna.value = (place.address_components[2] && place
                            .address_components[2]
                            .short_name || '');
