...
<div class="float-right ">
    <a href="{{ route('admin.sales.create') }}" class="btn btn-secondary">Venta Nueva</a>
</div>
    <h1>Editar Venta</h1>
@stop
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            {!! Form::model($venta, ['route' => ['admin.sales.update', $venta], 'files' => 'true', 'method' => 'put'])!!}
            @include('admin.sales.partials.form')
            {!! Form::submit('Actualizar Venta', ['class' => 'btn btn-primary validar_venta btn-block']) !!}
