...
Route::resource('marcas', BrandController::class)->middleware('can:admin.brands.index')->names('admin.brands');
...
Route::get('customer', [CustomerController::class,'index2'])->middleware('can:admin.customers.index')->name('admin.customers.lista');
Route::resource('clientes', CustomerController::class)->middleware('can:admin.customers.index')->names('admin.customers');
...
Route::get('ventas/create/{cliente_id}', [SaleController::class,'create'])->middleware('can:admin.sales.index')->name('admin.sales.create');
...
Route::get('users/index',[UserController::class,'newIndex'])->middleware('can:admin.users.index')->name('admin.users.newIndex');
Route::get('visits',[VisitController::class,'index'])->middleware('can:admin.home.index')->name('admin.visits.index');
...
Route::get('permission',[RoleController::class,'permission'])->middleware('can:admin.permissions.index')->name('admin.permission');
Route::get('pagos-pendientes',[SaleController::class,'pagosPendientes'])->middleware('can:admin.customers.index')->name('admin.sales.pagos_pendientes');

Route::resource('routes', RouteController::class)->middleware('can:admin.home.index')->names('routes');
